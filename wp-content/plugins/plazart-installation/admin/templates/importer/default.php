...
$items  = $this -> get_theme_demo_datas();
...
?>
<div class="plzinst-demo-import<?php echo !HelperLicense::is_authorised($this -> theme_name)?' no-license':''?>">
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card rounded-0 h-100 box">
                <img class="card-img-top" src="<?php echo $item['thumb']; ?>" alt="<?php echo $item['title']; ?>"/>
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="d-flex justify-content-between mt-auto action">
                        ...
                        <button type="button" data-toggle="modal" data-target="#plzinst-modal__import-<?php
            ...
            <div id="plzinst-modal__import-<?php echo $theme_name; ?>" class="modal fade" tabindex="-1" role="dialog" data-install-demo-data__modal>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer position-relative">
                            ...
                            <div class="action">
                                ...
                                <button type="button" class="btn btn-danger d-none" data-plzinst-stop-importing><?php
                                    echo _e('Stop Importing', $this -> text_domain); ?></button>
                                <button type="button" class="btn btn-primary js-plzinst-import">
