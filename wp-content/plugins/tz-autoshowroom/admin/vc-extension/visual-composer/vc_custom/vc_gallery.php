...
$thumbnail = '';
$title = $source = $type = $number_items = $onclick = $custom_links = $custom_links_target = $img_size = $external_img_size = $images = $custom_srcs = $el_class = $interval = $css = '';
$large_img_src = '';
...
if ( 'nivo' === $type ) {
	...
	$el_start = '<div class="autoshowroom-owlcarousel-item">';
	$el_end = '</div>';
	$slides_wrap_start = '<div class="autoshowroom-owlcarousel">';
	$slides_wrap_end = '</div>';
	wp_enqueue_style( 'autoshowroom-owl-carousel-style' );
	wp_enqueue_script( 'autoshowroom-owl-carousel-script' );
	wp_enqueue_script( 'autoshowroom-owl-carousel' );
	...
	$slides_wrap_end = '</ul>';
}elseif('autoshowroom_grid' === $type){
    $el_start = '<li class="autoshowroom-grid-item ">';
    $el_end = '</li>';
    $slides_wrap_start = '<ul id="autoshowroom-image-grid" class="autoshowroom-grid-ul ">';
    $slides_wrap_end = '</ul>';
}
...
if ( 'flexslider' === $type || 'flexslider_fade' === $type || 'fading' === $type ) {
    ...
    $type = ' autoshowroom-owl-carousel-container';
}elseif('autoshowroom_grid' === $type){
    $type = ' autoshowroom_grid';
}
...
$output .= '<div class="wpb_gallery_slides' . $type .  '" data-items="' . $number_items . '" data-interval="' . $interval . '"' . $flex_fx . '>' . $slides_wrap_start . $gal_images . $slides_wrap_end . '</div>';
$output .= '</div>';
$output .= '</div>';
