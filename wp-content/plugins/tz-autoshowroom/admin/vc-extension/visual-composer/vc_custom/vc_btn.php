...
?>
    ...
    if($tz_padding_top != '' || $tz_padding_bottom != '' || $tz_padding_right != '' || $tz_padding_left != ''){
        echo 'style="';
        if($tz_padding_top != ''){
            echo 'margin-top:'.esc_attr($tz_padding_top).'px;';
        }

        if($tz_padding_bottom != ''){
            echo 'margin-bottom:'.esc_attr($tz_padding_bottom).'px;';
        }

        if($tz_padding_left != ''){
            echo 'margin-left:'.esc_attr($tz_padding_left).'px;';
        }

        if($tz_padding_right != ''){
            echo 'margin-right:'.esc_attr($tz_padding_right).'px;';
        }
        echo '"';
    }
    ?>><?php if ( $use_link ) {
