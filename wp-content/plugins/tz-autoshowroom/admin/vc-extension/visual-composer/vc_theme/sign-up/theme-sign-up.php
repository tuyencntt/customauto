...
function autoshowroom_sign_up($atts, $content=null) {
    ...
    extract(shortcode_atts(array(
        ...
        'autoshowroom_image'                => '',
        'autoshowroom_position_x'           => '',
        'autoshowroom_position_y'           => '',
    ...
    <div class="autoshowroom-sign-up <?php echo esc_attr($autoshowroom_class);?>">
        ...
        <?php echo do_shortcode( '[easy_sign_up title="" phone="0" fnln="1" esu_label="A unique identifier for your form" esu_class=""] ' );?>
...
add_shortcode('autoshowroom-sign-up','autoshowroom_sign_up');
?>
