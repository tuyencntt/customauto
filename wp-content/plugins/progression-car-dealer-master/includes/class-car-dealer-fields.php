	...
	public function __construct() {
		...
		$this->built_in = array(
            ...
            'vehicle_status' => array(
                'label' => __( 'Vehicle sale/rent', 'progression-car-dealer' ),
                'name' => 'vehicle_status',
                'instructions' => '',
                'type' => 'radio',
                'choices' => array(
                    'sale' => __( 'For Sale', 'progression-car-dealer' ),
                    'rent' => __( 'For Rent', 'progression-car-dealer' ),
                ),
                'default_value' => 'sale',
                'other_choice' => 0,
                'sort' => 9,
            ...
            'time_rental' => array (
                'label' => __( 'Time unit for Rent', 'progression-car-dealer' ),
                'name' => 'time_rental',
                'type' => 'text',
                'default_value' => 'day',
