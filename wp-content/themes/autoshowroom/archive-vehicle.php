...
if(isset($_GET['orderby'])){
    ...
    $autoshowroom_orderby = ot_get_option('autoshowroom_orderby',$sort_value);
}else{
    $sort_value = '';
}
...
if(isset($_GET['order'])){
    ...
    $autoshowroom_order = ot_get_option('autoshowroom_order',$sort_price);
}
                                    ...
                                    <div class="TZ-Vehicle-Grid">
                                        <div class="item">
                                            ...
                                            if($sold=='sold'){ ?>
                                                ...
                                                <p class="pcd-pricing">
                                                    <span class="pcd-price"><?php echo esc_attr('$'.$daily);?><em> / per day</em></span>
                                                </p>
                                                <?php
                                            } elseif($pricetext !='') { ?>
                                                <p class="pcd-pricing">
